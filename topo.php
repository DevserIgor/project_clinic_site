...
<head>
    ...
    <!-- Page Title -->
    <title>Policlínica Menino Jesus</title>

    <!-- Favicon -->
    <link rel="shortcut icon" href="assets/images/logo/meninojesus_fav.png" type="image/x-icon">
    ...
    <header class="header-area">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3">
                        <div class="social-links">
                            <ul>
                                <li><a href="https://www.facebook.com/polimeninojesus" target="_blank"><i class="fa fa-facebook"></i></a></li>
                                <!--<li><a href="#"><i class="fa fa-linkedin"></i></a></li>-->
                                <!--<li><a href="#"><i class="fa fa-twitter"></i></a></li>-->
                                <li><a href="https://www.instagram.com/polimjesus" target="_blank"><i class="fa fa-instagram"></i></a></li>
        ...
        <div id="header" id="home">
            <div class="container">
                ...
                <div id="logo">
                    <a href="index.php"><img src="assets/images/logo/meninojesus_120.png" alt="Policlínica Menino Jesus" title="Policlínica Menino Jesus"/></a>
                </div>
                <nav id="nav-menu-container">
                    <ul class="nav-menu">
                        <li class="menu-active"><a href="index.php">Início</a></li>
                        <li class="menu-active"><a href="sobre.php">Sobre nós</a></li>
                        <li class="menu-active"><a href="especialidades.php">Especialidades</a></li>
