            ...
            <div class="row">
                <div class="col-lg-3 col-md-6">
                    <div class="single-feature text-center item-padding">
                        ...
                        <h3>Tecnologia<br>avançada</h3>
                        <p class="pt-3">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt</p>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6">
                    <div class="single-feature text-center item-padding mt-4 mt-md-0">
                        <img src="assets/images/feature2.png" alt="">
                        <h3>Espaço<br>confortável</h3>
                        <p class="pt-3">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt</p>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6">
                    <div class="single-feature text-center item-padding mt-4 mt-lg-0">
                        ...
                        <h3>Equipamentos<br>de qualidade</h3>
                        <p class="pt-3">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt</p>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6">
            ...
            <div class="row">
                <div class="col-lg-6 offset-lg-3">
                    <div class="section-top text-center">
                        ...
                        <p><br>A Policlínica Menino Jesus trabalha com diversas especialidades médicas em uma única unidade de saúde.<br><br>Veja os principais exames mais procurados diariamente:</p>
                    </div>
                </div>
            </div>
            <div class="row">
    ...
    <!-- Hotline Area Starts -->
    <section class="hotline-area text-center section-padding" style="background-image:url(assets/images/clinica.jpg);">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
